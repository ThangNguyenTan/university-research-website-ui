...
function Publications() {
  ...
  const { isLoading, isError, data, error } = useQuery({
    queryKey: ['fetchPublications', currentPage, ARTICLE_TYPES.PUBLICATION],
    queryFn: () => fetchPublications(currentPage, ARTICLE_TYPES.PUBLICATION),
  });
  ...
  return (
    <>
      <HelmetMeta
        title="Publications"
        description="You can view the information of all publications that we have posted on the website"
      />
      <div id="publications-page">
        <Navigator />
        <main id="publications-main" className="page-main">
          <Container>
            <Row>
              <Col lg="12" xl="8">
                <h1>Publications</h1>
